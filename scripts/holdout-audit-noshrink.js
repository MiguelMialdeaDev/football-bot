...
function predict(hf, af, leagueAvg) {
  ...
  // EXPERIMENTO: variableShrink desactivado. Solo caps duros.
...
console.log(" HOLDOUT AUDIT (NO-SHRINK) — walk-forward sin variableShrink");
console.log("=".repeat(70));
...
const out = path.join(__dirname, "holdout-audit-noshrink-results.json");
