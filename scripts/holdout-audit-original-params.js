...
// PARÁMETROS DEL BACKTEST ORIGINAL (football-backtest.json)
const BANKROLL = 5000;
const KELLY_FRACTION = 0.10;     // era 0.33 en paper-trade-compare
const MIN_EDGE = 0.01;           // era 0.06
const MAX_EDGE = 1.00;           // era 0.15 (cap removido)
const MAX_BET_PCT = 0.03;
const MIN_TEAM_MATCHES = 8;
// Sin zonas restringidas: cualquier odds entre 1.50 y 10.00 califica
const ZONES = {
  original: [[1.50, 10.00]],
};
...
console.log(" HOLDOUT AUDIT (ORIGINAL PARAMS) — walk-forward con parámetros del backtest original");
console.log("=".repeat(70));
...
const out = path.join(__dirname, "holdout-audit-original-params-results.json");
